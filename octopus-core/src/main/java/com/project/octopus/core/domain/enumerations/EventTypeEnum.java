...
public enum EventTypeEnum {
	INCLUSION(UUID.fromString("359478a8-f1f6-486e-bdc2-504bbead5fbc"), 1L, "Registry inclusion"),
	UPDATE(UUID.fromString("e2f4f40c-0340-4404-ad32-1a14692de709"), 2L, "Registry update"),
	DISABLING(UUID.fromString("d3320a32-b803-40f9-ab35-13c29833f214"), 3L, "Registry disabling"),
	REMOVAL(UUID.fromString("a6c4efd6-0407-4bfb-9400-dd6618b0b069"), 4L, "Registry removal"),
